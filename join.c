...
/* Creation de 2 threads: la 1ere calcule a*b et la 2eme c*d
la thread initiale attend les 2 resultats et fait leur somme
    a, b, c et d sont passes en arguments au programme */
...
if(argc < 5) { perror("\007Nbre d'arguments incorrect"); exit(1);}
